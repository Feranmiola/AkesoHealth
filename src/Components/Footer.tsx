...
const Footer = () => {
    return (
        <div className='flex flex-col items-center justify-between w-screen h-[641px] bg-[#F8F8F8] py-10 '>
            ...
            <p className='text-[#656565] text-sm font-inter-var'>(c) Copyright Akeso Health, 2024</p>
        </div>
    )
}
